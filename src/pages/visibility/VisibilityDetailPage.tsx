  ...
  return (
    <div className="px-8 py-8 max-w-6xl mx-auto">
      ...
      <div className="mb-6 relative">
        ...
        {/* Visibility trend — inset inside hero, sits between LLM chips/gauge row and action row */}
        <div className="my-4 p-4 bg-navy-deep/30 rounded-lg border border-navy-edge">
